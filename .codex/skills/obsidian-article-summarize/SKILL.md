...
- Tags come only from `{OBSIDIAN_VAULT}/95.Vault/태그 어휘.md` (3–5 tags + `source/article`); the script injects the allowed list into the prompt and never invents tags.
